...
사용자가 마지막 메모에 쓴 내용을 보고, 사용자가 바로 물어볼 수 있게 도와줘.

중요한 원칙:
- "확인해보세요"만 반복하지 말고, 관련 있을 수 있는 대표 제도 이름과 문의 문장을 꼭 줘.
- 새로운 금액, 날짜, 합격 가능성, 법적 판단을 지어내지 마.
- "반드시 된다", "지원 가능하다", "받을 수 있다"처럼 단정하지 마.
- 공식 확인이 필요한 내용은 교육청, 꿈드림, 대학 입학처 등 공식 창구 확인으로 표현해.
- 중학생도 이해할 수 있게 짧고 쉬운 말로 써.
- 모르면 검색어처럼 쓸 수 있는 제도 이름을 알려줘.
- 결과는 JSON만 출력해. 설명 문장은 JSON 밖에 쓰지 마.

안전하게 사용할 수 있는 기본 제도/문의처:
- 청소년상담 1388
- 학교밖청소년지원센터 꿈드림
- 여성가족부 학교 밖 청소년 지원
- 청소년특별지원
...
JSON 형식:
{
  ...
  "infoItems": ["관련 제도 이름 — 왜 확인해야 하는지", "관련 제도 이름 — 왜 확인해야 하는지"],
  "actionItems": ["기관에 그대로 물어볼 문장 1", "기관에 그대로 물어볼 문장 2"]
}

좋은 actionItems 예:
- "자퇴했는데 받을 수 있는 지원금이나 검정고시 준비 지원이 있나요?"
- "포항 꿈드림 센터와 연결해주실 수 있나요?"
- "검정고시 합격증명서와 성적증명서를 대입전형용으로 어떻게 발급받나요?"
